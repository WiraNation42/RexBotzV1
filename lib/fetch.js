...
exports.createExif = (pack, auth) => {
    ...
    const exif = {"sticker-pack-id": "com.nino.tech", "sticker-pack-name": pack, "sticker-pack-publisher": auth, "android-app-store-link": "https://play.google.com/store/apps/details?id=com.termux", "ios-app-store-link": "https://itunes.apple.com/app/stickers-maker-studio/id1443326857"}
    ...
    fs.writeFileSync('./stickers/data.exif', Buffer.concat([_, __, ___, ____]), function (err) {
        console.log(err)
